...
[![Gource Video](https://img.shields.io/badge/View-Gource-Video-brightgreen)](./gource.mp4)

[ ![Gource](./gource/gource.png) ](./gource.mp4)

*The video is automatically generated by the [Gource workflow](.github/workflows/gource.yml) on each push — rendered via [nbprojekt/gource-action@v1.3.0](https://github.com/marketplace/actions/gource-action).*
